...
import { removeNonNumericCharacters, removePhoneMask, parserDate } from './string'

export const allInputInstancesAreValid = (instances) => !instances.some((instance) => instance.empty || instance.error)
